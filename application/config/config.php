...
define("EMAIL_PASSWORD_VERIFICATION_URL", URL . "login/verify");
define("EMAIL_PASSWORD_VERIFICATION_FROM_EMAIL", "no-reply@example.com");
define("EMAIL_PASSWORD_VERIFICATION_FROM_NAME", "My Project");
define("EMAIL_PASSWORD_VERIFICATION_SUBJECT", "Account activation for PROJECT XY");
define("EMAIL_PASSWORD_VERIFICATION_CONTENT", "Please click this link to activate your account: ");
/**
...
define('EMAIL_VERIFICATION_FROM_EMAIL', 'Verification');
define('FEEDBACK_ACCOUNT_ACTIVATION_SUCCESFULL' , 'Account activation completed');
define('FEEDBACK_ACCOUNT_ACTIVATION_FAILED', 'Account activation failed');
define('FEEDBACK_ACCOUNT_NOT_ACTIVATED_YET', 'Account not activated');