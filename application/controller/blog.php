...
class Blog extends Controller
{
    ...
    public function index()
    {
        ...
        $this->view->amount_of_blogs = $this->model->getAmountOfBlogs();
    ...
    public function addBlog()
    {
        ...
        if (isset($_POST["submit_add_blog"])) {
            ...
            $this->model->addBlog($_POST["author"], $_POST["title"],  $_POST["content"]);
        }
    ...
    public function editBlog($blog_id)
    {
        ...
        if (isset($blog_id)) {
            ...
            $this->view->song = $this->model->getBlog($blog_id);
    ...
    public function updateSong()
    {
        ...
        // if we have POST data to create a new song entry
        if (isset($_POST["submit_update_blogs"])) {
            // do updateSong() from model/model.php
            $this->model->updateSong($_POST["author"], $_POST["title"],  $_POST["author"], $_POST['blog_id']);
        }
    ...
    public function ajaxGetStats()
    {
        ...
        $this->amount_of_blogs = $this->model->getAmountOfBlogs();

        // simply echo out something. A supersimple API would be possible by echoing JSON here
        echo $this->amount_of_blogs;
    }
